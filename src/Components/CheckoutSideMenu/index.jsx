...
const CheckoutSideMenu = () => {
  ...
  return  (
    <aside className={`${context.isCheckoutSideMenuOpen ? 'flex' : 'hidden'} py-10 checkout-side-menu flex-col fixed right-0 top-0 h-full w-80 border-l border-gray-300 shadow-lg rounded-l-lg bg-white transition-transform duration-300 ease-in-out`}>
        <div className='flex justify-between items-center p-6 border-b border-gray-200 relative'>
            <h2 className='font-medium text-xl text-gray-800'>Mi Encargo</h2>
